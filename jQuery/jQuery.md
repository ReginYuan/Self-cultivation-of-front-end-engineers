...
推荐书籍：《Javascript忍者禁术》、《精通Javascript》
...
| :lt()        |                                    |                                                              |
| :gt()        |                                    |                                                              |
| :gt():lt()   |                                    | 先选出大于该索引的元素，然后索引从0开始，再从中挑小于指定索引的元素 |
...
| eq(index)          | $(“li”).eq(2);s             | 相当于$(“li:eq(2)”),index从0开始 |
| next()             | $(“li”).next()              | 找下一个兄弟                     |
| prev()             | $(“li”).prev()              | 找上一次兄弟                     |
...
obj.show([speed],[fn])
//spead:动画的执行时间
	//1、show,hide不传值则无动画效果，slide和fade默认normal
